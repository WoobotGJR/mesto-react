...
export default function EditProfilePopup(props) {
    ...
    return (
        <PopupWithForm title="Редактировать профиль" name="profile-edit" buttonText="Сохранить" isOpened={props.isOpen} onClose={props.onClose} onSubmit={handleSubmit} >
            ...
            onChange={handleNameInput} value={name || ""} // данные в стейте могут не прогрузиться и в полях ввода значения undefined
            />
            ...
            onChange={handleDescriptionInput} value={description || ""} // данные в стейте могут не прогрузиться и в полях ввода значения undefined
            />
